...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            model.ASense = item->valueint;
        }
        // Receive VSense
        item = cJSON_GetObjectItemCaseSensitive(root, "VSense");
        if(item != NULL) {
            model.VSense = item->valueint;
        }
        // Receive deltaT
        ...
        if(item != NULL) {
            model.APace = item->valueint;
        }
        // Receive VPace
        item = cJSON_GetObjectItemCaseSensitive(root, "VPace");
        if(item != NULL) {
            model.VPace = item->valueint;
        }
        // Receive sleepT
        ...
        if(item != NULL) {
            model.PVARP_event = item->valueint;
        }
        // Receive URI
        ...
        if(item != NULL) {
            model._pg103 = item->valueint;
        }
        // Receive _pg107
        item = cJSON_GetObjectItemCaseSensitive(root, "_pg107");
        if(item != NULL) {
            model._pg107 = item->valueint;
        }
        // Receive _pg120
        ...
        if(item != NULL) {
            model._pg178 = item->valueint;
        }
        // Receive _pg182
        item = cJSON_GetObjectItemCaseSensitive(root, "_pg182");
        if(item != NULL) {
            model._pg182 = item->valueint;
        }
        // Receive _pg19
...
void sendVariables(int send_interface) {
    ...
    // Send ASense
    cJSON_AddItemToObject(root, "ASense", cJSON_CreateBool(model.ASense));
    // Send VSense
    cJSON_AddItemToObject(root, "VSense", cJSON_CreateBool(model.VSense));
    // Send deltaT
    cJSON_AddItemToObject(root, "deltaT", cJSON_CreateNumber(model.deltaT));
    // Send APace
    cJSON_AddItemToObject(root, "APace", cJSON_CreateBool(model.APace));
    // Send VPace
    cJSON_AddItemToObject(root, "VPace", cJSON_CreateBool(model.VPace));
    // Send sleepT
    ...
    // Send AEI_event
    cJSON_AddItemToObject(root, "AEI_event", cJSON_CreateBool(model.AEI_event));
    // Send AVI
    cJSON_AddItemToObject(root, "AVI", cJSON_CreateBool(model.AVI));
    // Send AVI_event
    cJSON_AddItemToObject(root, "AVI_event", cJSON_CreateBool(model.AVI_event));
    // Send LRI
    cJSON_AddItemToObject(root, "LRI", cJSON_CreateBool(model.LRI));
    // Send LRI_event
    cJSON_AddItemToObject(root, "LRI_event", cJSON_CreateBool(model.LRI_event));
    // Send PVARP
    cJSON_AddItemToObject(root, "PVARP", cJSON_CreateBool(model.PVARP));
    // Send PVARP_event
    cJSON_AddItemToObject(root, "PVARP_event", cJSON_CreateBool(model.PVARP_event));
    // Send URI
    cJSON_AddItemToObject(root, "URI", cJSON_CreateBool(model.URI));
    // Send URI_event
    cJSON_AddItemToObject(root, "URI_event", cJSON_CreateBool(model.URI_event));
    // Send VRP
    cJSON_AddItemToObject(root, "VRP", cJSON_CreateBool(model.VRP));
    // Send VRP_event
    cJSON_AddItemToObject(root, "VRP_event", cJSON_CreateBool(model.VRP_event));
    // Send _GO
    ...
    cJSON_AddItemToObject(root, "_PaceMaker_local__Atrig10", cJSON_CreateBool(model._PaceMaker_local__Atrig10));
    // Send _PaceMaker_local__Atrig11
    cJSON_AddItemToObject(root, "_PaceMaker_local__Atrig11", cJSON_CreateBool(model._PaceMaker_local__Atrig11));
    // Send _PaceMaker_local__Atrig12
    cJSON_AddItemToObject(root, "_PaceMaker_local__Atrig12", cJSON_CreateBool(model._PaceMaker_local__Atrig12));
    ...
    // Send _cg175
    cJSON_AddItemToObject(root, "_cg175", cJSON_CreateBool(model._cg175));
    // Send _cg177
    ...
    // Send _cg183
    cJSON_AddItemToObject(root, "_cg183", cJSON_CreateBool(model._cg183));
    // Send _cg21
    ...
    // Send _g169_e1
    cJSON_AddItemToObject(root, "_g169_e1", cJSON_CreateBool(model._g169_e1));
    // Send _g172
    ...
    // Send _g176_e2
    cJSON_AddItemToObject(root, "_g176_e2", cJSON_CreateBool(model._g176_e2));
    // Send _g177
    ...
    // Send _g184_e3
    cJSON_AddItemToObject(root, "_g184_e3", cJSON_CreateBool(model._g184_e3));
    // Send _g185
    ...
    // Send _g62_e1
    cJSON_AddItemToObject(root, "_g62_e1", cJSON_CreateBool(model._g62_e1));
    // Send _g65
    ...
    // Send _g77_e3
    cJSON_AddItemToObject(root, "_g77_e3", cJSON_CreateBool(model._g77_e3));
    // Send _g83
    ...
    // Send _pg103
    cJSON_AddItemToObject(root, "_pg103", cJSON_CreateBool(model._pg103));
    // Send _pg107
    cJSON_AddItemToObject(root, "_pg107", cJSON_CreateBool(model._pg107));
    // Send _pg120
    ...
    // Send _pg167
    cJSON_AddItemToObject(root, "_pg167", cJSON_CreateBool(model._pg167));
    // Send _pg172
    cJSON_AddItemToObject(root, "_pg172", cJSON_CreateBool(model._pg172));
    // Send _pg178
    cJSON_AddItemToObject(root, "_pg178", cJSON_CreateBool(model._pg178));
    // Send _pg182
    cJSON_AddItemToObject(root, "_pg182", cJSON_CreateBool(model._pg182));
    // Send _pg19
    ...
    // Send _pg65
    cJSON_AddItemToObject(root, "_pg65", cJSON_CreateBool(model._pg65));
    // Send _pg71
    cJSON_AddItemToObject(root, "_pg71", cJSON_CreateBool(model._pg71));
    // Send _pg75
    cJSON_AddItemToObject(root, "_pg75", cJSON_CreateBool(model._pg75));
    // Send _pg83
    cJSON_AddItemToObject(root, "_pg83", cJSON_CreateBool(model._pg83));
    // Send _pg92
    cJSON_AddItemToObject(root, "_pg92", cJSON_CreateBool(model._pg92));
    // Send _pg97
    cJSON_AddItemToObject(root, "_pg97", cJSON_CreateBool(model._pg97));
    // Send _region0_AVI_AVI_clock
    cJSON_AddItemToObject(root, "_region0_AVI_AVI_clock", cJSON_CreateNumber(model._region0_AVI_AVI_clock));
    // Send _region1_PVARP_PVARP_clock
    cJSON_AddItemToObject(root, "_region1_PVARP_PVARP_clock", cJSON_CreateNumber(model._region1_PVARP_PVARP_clock));
    // Send _region2_VRP_VRP_clock
    cJSON_AddItemToObject(root, "_region2_VRP_VRP_clock", cJSON_CreateNumber(model._region2_VRP_VRP_clock));
    // Send _region3_AEI_AEI_clock
    cJSON_AddItemToObject(root, "_region3_AEI_AEI_clock", cJSON_CreateNumber(model._region3_AEI_AEI_clock));
    // Send _region4_LRI_LRI_clock
    cJSON_AddItemToObject(root, "_region4_LRI_LRI_clock", cJSON_CreateNumber(model._region4_LRI_LRI_clock));
    // Send _region5_URI_URI_clock
    cJSON_AddItemToObject(root, "_region5_URI_URI_clock", cJSON_CreateNumber(model._region5_URI_URI_clock));
